...
class CompiledModel(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["model_id", "model_path", "id", "created", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["model_id", "model_path", "id", "created", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        model_id: typing.Union[MetaOapg.properties.model_id, decimal.Decimal, int, ],

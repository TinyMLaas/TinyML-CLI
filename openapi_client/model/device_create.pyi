...
class DeviceCreate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "installer_id", "model", "description", "serial", "connection", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "installer_id", "model", "description", "serial", "connection", ], str]):
